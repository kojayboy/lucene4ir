 ...
 */
public class FieldedRetrieval extends RetrievalApp {
    public Fields fl;
    public Field fp;
    ...
    public FieldedRetrieval(String retrievalParamFile) {
    ...
    public static void main(String []args) {
        ...
        FieldedRetrieval retriever = new FieldedRetrieval(retrievalParamFile);
